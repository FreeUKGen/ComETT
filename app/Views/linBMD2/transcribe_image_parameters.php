	...
	<div>
		<b>
			<div class="row">
				...
				<p class="col-2 text-center">Rotate</p>
			</div>
		</b>
	</div>
	...
	<div>
			<div class="row">
				...
				<p class="col-2 text-center"><?php echo($session->image_r);?></p>
			</div>
	</div>
	...
	<div>
		<form action="<?php echo(base_url('transcribe/image_parameters_step2/'.$session->transcribe_header[0]['BMD_header_index'])); ?>" method="post">
			<div class="form-group row">
				...
				<input type="text" class="form-control col-2 text-center" id="image_rotate" name="image_rotate" autofocus value="<?php echo esc($session->image_r);?>">
			</div>
