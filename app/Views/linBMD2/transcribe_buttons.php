		...
		<div class="alert row mt-2 d-flex justify-content-between">
				...
				<a id="return" class="btn btn-primary mr-0 flex-column align-items-center" href="<?php echo(base_url('transcribe/enter_parameters_step1/0')); ?>">
					<span>Change the data entry parameters</span>
				</a>
