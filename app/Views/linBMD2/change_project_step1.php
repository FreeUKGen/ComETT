<?php $session = session(); ?>
	...
	<form action="<?php echo(base_url('projects/manage_projects_step3')) ?>" method="post">
		...
		<div class="form-group row">
			<p class="col-2 pl-0 text-left" style="font-size:1vw;">Image Server type</p>
			<p class="col-4 pl-0 text-left" style="font-size:1vw;"><?php echo($session->project_values[0]['project_autoimageservertype']) ?></p>
			<input type="text" class="form-control col-4 text-left" style="font-size:1vw;" id="project_autoimageservertype" name="project_autoimageservertype" aria-describedby="userHelp" value="<?php echo($session->new_project_autoimageservertype) ?>">
			<p class="col-2 pl-0 text-left" style="font-size:0.8vw;">A server type.
			</p>
		</div>
		
		<div class="form-group row">
			<p class="col-2 pl-0 text-left" style="font-size:1vw;">Image URL</p>
			<p class="col-4 pl-0 text-left" style="font-size:1vw;"><?php echo($session->project_values[0]['project_autoimageurl']) ?></p>
			<input type="text" class="form-control col-4 text-left" style="font-size:1vw;" id="project_autoimageurl" name="project_autoimageurl" aria-describedby="userHelp" value="<?php echo($session->new_project_autoimageurl) ?>">
