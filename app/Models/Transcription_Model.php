...
class Transcription_Model extends Model
{
    ...
    protected $allowedFields = ['project_index','BMD_header_index', 'BMD_file_name', 'BMD_scan_name', 'BMD_start_date', 'BMD_end_date',
													...
													'BMD_font_family', 'verified', 'last_verified_detail_index', 'zoom_lock',
													'header_x', 'header_y',];
